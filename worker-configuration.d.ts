/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2ca35d16381b2b3bd0183791b9fe6707)
// Runtime types generated with workerd@1.20260312.1 2026-03-16 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV_DATA: KVNamespace;
		DB: D1Database;
		NEXT_PUBLIC_SITE_URL: "https://dda-portal.pages.dev";
		AUTH_SECRET: string;
		NEXTAUTH_URL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SITE_URL" | "AUTH_SECRET" | "NEXTAUTH_URL">> {}
}
